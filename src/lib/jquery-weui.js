...
/**
 * 修改部分
 * Pull to refreh 禁用touchmove的e.stopPropagation()
 * Infinite 计算offset不取绝对值
 * 修复picker会滚动页面的bug e.preventDefault()执行延迟500ms
 * 不使用template7模板，使用underscore_.template()模板，使用该改动时，必须引入underscore.js
 */
